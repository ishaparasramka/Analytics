...
#Model
tree1 = rpart(Sales ~ . , data=data, method='anova' ) #instead of writing all names we can just put a '.' #annova was used because its a regression tree
tree1
...
prunetree = prune(tree1, cp=0.012)
...
cbind(testdata, predictedSales) #combination of the 2 columns
