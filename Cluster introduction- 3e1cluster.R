...
km1$betweenss # the higher the value the better is the clustering process #maximize
km1$tot.withinss #minimize the within distance
km1$withinss
km1$betweenss/ (km1$beweenss = km1$tot.withinss)
