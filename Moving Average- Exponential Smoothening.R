...
kings <- scan("http://robjhyndman.com/tsdldata/misc/kings.dat",skip=3) #skip the first 3 lines which do not contain the data
kings
kingstimeseries <- ts(kings) #not specified frequency, so it becomes yearly data frequency=1
kingstimeseries
...
library(forecast) #exponential smoothening
